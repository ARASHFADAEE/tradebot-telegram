        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">turbo trade</span>
                </a>
                        ...
                        <li class="nav-item">
                            <a href="#" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">تنظیمات چت</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">مدیریت کاربران</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="#" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">اشتراک ها</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/apps/scrumboard.php" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">پرداخت ها</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">ارسال پیام همگانی</span>
                                </div>
                            </a>
                        </li>
